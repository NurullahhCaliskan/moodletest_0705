...
/**
 * A login page layout for the wellko theme.
 *
...
if ($theme->settings->loginposition == 'Center') {
    $templatecontext['loginposition'] = "justify-content-center";
...
echo $OUTPUT->render_from_template('theme_wellko/login', $templatecontext);

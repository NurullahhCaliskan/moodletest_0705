...
$page->add($setting);
// Blog masonry page s1 enable or disable settings.
...
format_text( '', FORMAT_MARKDOWN)));
$page->add($setting);
// Enable or disable blog masonry page settings.

...
/**
 * Returns HTML to display course.
 *
 * @param theme_wellko_core_course_renderer
 * @return string
 */
class theme_wellko_core_course_renderer extends core_course_renderer {
    /**
 ...
 *
 * @param theme_wellko_core_blog_renderer $entry
 * @return string
 */
class theme_wellko_core_blog_renderer extends core_blog_renderer {
    /**
     * Returns HTML to display blog entry.
     *
    ...
    public function render_blog_entry(blog_entry $entry) {
        ...
        $mainclass = 'forumpost blog_entry blog clearfix wellko-blog ';
        ...
        // Post content.
        $o .= $this->output->container_start('row maincontent clearfix wellko-blog-post');
        ...
        $o .= $this->output->container_start('wellko-blog-header row header clearfix');
    ...
    public function render_blog_entry_attachment(blog_entry_attachment $attachment) {
        ...
        if (file_mimetype_in_typegroup($attachment->file->get_mimetype(), 'web_image')) {
            ...
            $class = 'wellko-blog-img attachedimages';
        } else {

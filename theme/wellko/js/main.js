(function($) {
    ...
    function doSticky() {
        if (window.pageYOffset > headerHeight) {
            header.addClass("wellko-sticky");
        } else {
            header.removeClass("wellko-sticky");
        }
    ...
    if (idvar) {
        document.getElementById("theme-info").innerHTML = "Moodle Theme Wellko - Writer Themes Almond";
    }
    //On scroll events
    ...
    $(document).ready(function() {
        $('.preloader-image-link').magnificPopup({type:'image'});
    });
    // Filter Isotope
    function doIsotope() {
        var $filterGrid = '';
